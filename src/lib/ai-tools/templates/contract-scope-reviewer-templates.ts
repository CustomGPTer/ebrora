...
function coverPage(d: any, templateTitle: string, accent: string): (Paragraph | Table)[] {
  return [
    ...
    metaTable(d, accent),
    h.spacer(200),
    // Discreet Ebrora branding
    new Paragraph({
      alignment: AlignmentType.CENTER,
      spacing: { before: 400 },
      children: [new TextRun({ text: 'Generated by Ebrora · ebrora.com', size: 14, font: 'Arial', color: 'B0B0B0', italics: true })],
    }),
...
function buildQuickRiskSummary(d: any): (Paragraph | Table)[] {
  ...
  children.push(new Paragraph({
    spacing: { after: 40 },
    children: [new TextRun({ text: 'This review is generated by AI and should be verified by a qualified contracts professional before reliance.', size: 14, font: 'Arial', color: GREY, italics: true })],
  }));

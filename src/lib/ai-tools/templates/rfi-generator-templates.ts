// =============================================================================
// REQUEST FOR INFORMATION — Multi-Template Engine (3 templates: Formal, Corporate, Concise)
// =============================================================================
import {
...
const PALETTES: Record<RfiTemplateSlug, Palette> = {
  'formal-letter': { primary: '1E40AF', accent: '1E40AF', dark: '1E293B', mid: '64748B', rowAlt: 'EFF6FF', font: 'Arial', bodySize: 20 },
...
function sectionHead(slug: RfiTemplateSlug, p: Palette, num: number, title: string): Paragraph | Table {

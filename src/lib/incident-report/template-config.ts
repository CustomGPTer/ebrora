...
export const INCIDENT_REPORT_TEMPLATE_CONFIGS: Record<IncidentReportTemplateSlug, IncidentReportTemplateConfig> = {
  'ebrora-standard': {
    ...
    previewPaths: [
      ...
      '/product-images/incident-report-templates/preview-ebrora-standard-p5.jpg',
      '/product-images/incident-report-templates/preview-ebrora-standard-p6.jpg',
      '/product-images/incident-report-templates/preview-ebrora-standard-p7.jpg',
    ],
    keySections: [
  ...
  'riddor-focused': {
    ...
    previewPaths: [
      ...
      '/product-images/incident-report-templates/preview-riddor-focused-p5.jpg',
      '/product-images/incident-report-templates/preview-riddor-focused-p6.jpg',
    ],
    keySections: [
  ...
  'root-cause': {
    ...
    previewPaths: [
      ...
      '/product-images/incident-report-templates/preview-root-cause-p5.jpg',
      '/product-images/incident-report-templates/preview-root-cause-p6.jpg',
      '/product-images/incident-report-templates/preview-root-cause-p7.jpg',
    ],
    keySections: [
  ...
  'near-miss': {
    ...
    previewPaths: [
      ...
      '/product-images/incident-report-templates/preview-near-miss-p4.jpg',
      '/product-images/incident-report-templates/preview-near-miss-p5.jpg',
    ],
    keySections: [

  ...
  "hazards": [
    {
      ...
      "activity": "string (the work activity or task step this hazard relates to)",
      "hazard": "string",
      "whoAtRisk": "string",
...
JSON SCHEMA:
{
  ...
  "hazards": [{ "ref": "string", "activity": "string (work activity or task step)", "hazard": "string", "whoAtRisk": "string", "consequence": "string (what could happen — e.g. 'Electrocution, fatality', 'Fracture, lost time injury')", "likelihoodInitial": number, "severityInitial": number, "riskRatingInitial": number, "controlMeasures": "string", "likelihoodResidual": number, "severityResidual": number, "riskRatingResidual": number, "additionalControls": "string", "owner": "string (person responsible for ensuring controls are in place)", "verified": "string (verification status — use 'Pending' as default)" }],
  "sequenceOfWorks": "string (min 500 words, numbered steps separated by \\n\\n)",
...
JSON SCHEMA:
{
  ...
  "hazards": [{ "ref": "string", "activity": "string (work activity or task step)", "hazard": "string", "whoAtRisk": "string", "likelihoodInitial": number, "severityInitial": number, "riskRatingInitial": number, "controlMeasures": "string", "likelihoodResidual": number, "severityResidual": number, "riskRatingResidual": number, "cdmCategory": "string (e.g. Excavations, Work at Height, Live Services)", "cdmRef": "string (cross-ref to CDM Risk Flags or Designer Risk Schedule)", "verified": "string (use 'Pending' as default)" }],
  "sequenceOfWorks": "string (min 500 words, numbered steps separated by \\n\\n)",
  "ppeRequirements": "string (min 100 words)", "competencyRequirements": "string (min 100 words)", "temporaryWorks": "string (min 100 words)",
  "environmentalConsiderations": "string (min 100 words)", "wasteManagement": "string (min 100 words)",
  "emergencyProcedures": "string (min 100 words)", "welfareFacilities": "string (min 100 words)",
...
JSON SCHEMA:
{
  ...
  "hazards": [{ "ref": "string", "activity": "string (work activity or task step)", "hazard": "string", "whoAtRisk": "string", "likelihoodInitial": number, "severityInitial": number, "riskRatingInitial": number, "controlMeasures": "string", "likelihoodResidual": number, "severityResidual": number, "riskRatingResidual": number, "responsible": "string (person or role responsible for implementing controls)", "pcComment": "string (PC review comment — use '[PC to review]' as default)" }],
  "sequenceOfWorks": "string (min 500 words, numbered steps separated by \\n\\n)",
  "ppeRequirements": "string (min 100 words)", "competencyRequirements": "string (min 100 words)", "temporaryWorks": "string (min 100 words)",
  "environmentalConsiderations": "string (min 100 words)", "wasteManagement": "string (min 100 words)",
  "emergencyProcedures": "string (min 100 words)", "welfareFacilities": "string (min 100 words)",
...
JSON SCHEMA:
{
  ...
  "preparedBy": "string", "workingHours": "string", "workforceSize": "string",
  "taskDescription": "string (min 100 words)",
  "hazards": [{ "ref": "string", "activity": "string (work activity or task step)", "hazard": "string", "whoAtRisk": "string", "likelihoodInitial": number, "severityInitial": number, "detectabilityInitial": number, "rpnInitial": number, "controlMeasures": "string", "detectionMethod": "string", "likelihoodResidual": number, "severityResidual": number, "detectabilityResidual": number, "rpnResidual": number }],
...
JSON SCHEMA:
{
  ...
  "hazards": [{ "ref": "string", "activity": "string (work activity or task step)", "hazard": "string", "whoAtRisk": "string", "likelihoodInitial": number, "severityInitial": number, "riskRatingInitial": number, "controlMeasures": "string", "checkRequired": "string (what verification or inspection is needed for this hazard)", "likelihoodResidual": number, "severityResidual": number, "riskRatingResidual": number, "verified": "string (use 'Pending' as default)" }],

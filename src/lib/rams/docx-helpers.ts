...
/** Standard Ebrora header for all pages */
export function ebroraHeader(): Header {
  return new Header({
    children: [
      new Paragraph({
        ...
        children: [
          ...
          new TextRun({ text: '  |  RAMS Document', size: 16, font: 'Arial', color: GREY_DARK }),
        ],
      }),
    ],
  });
  ...
  return new Footer({
    children: [
      new Paragraph({
        ...
        spacing: { before: 0 },
        children: [
          new TextRun({ text: 'Generated by Ebrora RAMS Builder  |  www.ebrora.com  |  Page ', size: 14, font: 'Arial', color: GREY_DARK }),

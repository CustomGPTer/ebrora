    ...
    sections: [
      // SECTION 1 — Portrait Front Page (narrative style)
      {
        ...
        children: [
          ...
          narrativeBody(content.introduction),
          h.spacer(100),

          narrativeHeading('Description of Works'),
          narrativeSubHeading('Overview'),
          narrativeBody(content.worksOverview),
          narrativeSubHeading('Location & Site Conditions'),
          narrativeBody(content.locationSiteConditions),
          narrativeSubHeading('Duration & Working Hours'),
          narrativeBody(content.durationWorkingHours),
          narrativeSubHeading('Workforce & Supervision'),
          narrativeBody(content.workforceSupervision),
          h.spacer(100),

          narrativeHeading('Competency & Training'),
          narrativeBody(content.competencyTrainingNarrative),
          h.spacer(100),

          narrativeHeading('Permits & Consents'),
          narrativeBody(content.permitsConsentsNarrative),
          h.spacer(100),
      ...
      // SECTION 3 — Portrait Method Statement (narrative sections)
      {
        ...
        children: [
          ...
          narrativeBody(content.additionalNotes || 'No additional notes.'),
    ...
    rows: [
      new TableRow({
        children: [
          ...
          h.headerCell('Initial', cols[3], { fontSize: 11, alignment: AlignmentType.CENTER }),
          h.headerCell('Control Measures & Arrangements', cols[4], { fontSize: 11 }),
          h.headerCell('Residual', cols[5], { fontSize: 11, alignment: AlignmentType.CENTER }),
          h.headerCell('Responsible', cols[6], { fontSize: 11 }),

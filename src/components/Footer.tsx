        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-gray-800 text-gray-400 hover:bg-[#1B5B50] hover:text-white transition-colors"
                aria-label="LinkedIn"
              >
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/toolbox-talks" className="text-sm text-gray-400 hover:text-white transition-colors">Toolbox Talks</Link>
              <Link href="/tools" className="text-sm text-gray-400 hover:text-white transition-colors">Free Tools</Link>
              <Link href="/free-templates" className="text-sm text-gray-400 hover:text-white transition-colors">Free Templates</Link>
              <Link href="/rams-builder" className="text-sm text-gray-400 hover:text-white transition-colors">RAMS Builder</Link>
              <Link href="/blog" className="text-sm text-gray-400 hover:text-white transition-colors">Blog</Link>
              <a href="/#previews" className="text-sm text-gray-400 hover:text-white transition-colors">Free PDF Previews</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a href="mailto:hello@ebrora.com" className="text-sm text-gray-400 hover:text-white transition-colors">Email Support</a>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/faq" className="text-sm text-gray-400 hover:text-white transition-colors">Help Centre</Link>
              <Link href="/refund-policy" className="text-sm text-gray-400 hover:text-white transition-colors">Refund Policy</Link>

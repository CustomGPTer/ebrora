...
const AiSparkleIcon = () => (
  <svg className="hp-ai-sparkle" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '18px', height: '18px' }}>
    <path d="M12 1L14.59 8.41L22 11L14.59 13.59L12 21L9.41 13.59L2 11L9.41 8.41L12 1Z" fill="#D4A44C"/>
  </svg>
);
                ...
                <div className="hp-a3-card__inner">
                  <div className="hp-a3-card__top">
                    ...
                    <div className="hp-a3-card__badges">
                      <span className="hp-a3-card__ai-sparkle"><AiSparkleIcon /></span>
                      {tool.isPopular && (

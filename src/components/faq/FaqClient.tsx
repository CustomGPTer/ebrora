  ...
  return (
    <>
        ...
        <div className="container">
          ...
          {!hasResults && searchQuery && (
            <div className="no-results visible" id="faqNoResults">
              ...
              <h3 className="no-results__title">No matching questions found</h3>
          ...
          {filteredSections.map((section) => (
            ...
            >
              <h2 className="faq-section__heading">{section.title}</h2>
      ...
      <div className="faq-cta">
        ...
        <p>
          Our team is happy to help with any questions about our templates, purchasing, or custom
          services.
        </p>

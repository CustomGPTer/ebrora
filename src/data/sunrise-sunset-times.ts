...
export const REGULATORY_REFS = [
  { code: "CDM 2015 Reg 34", title: "Lighting", description: "Every workplace and approach must have suitable and sufficient lighting, which shall be by natural light so far as is reasonably practicable." },
  ...
  { code: "DMRB CD 128", title: "Safety at Roadworks", description: "Requires adequate lighting for roadworks and consideration of daylight hours when planning traffic management." },
];

export const WHY_IT_MATTERS = "Knowing exact sunrise, sunset, and civil twilight times is critical for construction site planning. CDM 2015 Regulation 34 requires workplaces to have suitable lighting — natural light where reasonably practicable. Civil twilight (when the sun is within 6° below the horizon) provides enough ambient light for outdoor work without artificial lighting. Planning shift patterns, task sequencing, and temporary lighting deployment around daylight hours improves safety, reduces energy costs, and ensures regulatory compliance. During winter months, UK construction sites may have as little as 7 hours of usable daylight, making accurate planning essential.";

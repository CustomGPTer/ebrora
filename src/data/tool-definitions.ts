...
export const TOOL_DEFINITIONS: FreeToolData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Convert between tonnes, m3, kg, litres, m2, bags, loads",
      "Loose vs compacted density switching",
      "Cost estimating with rate per tonne",
      "Embodied carbon (ICE v3 emission factors)",
      "Category totals and grand totals",
    ],
    status: "COMING_SOON",

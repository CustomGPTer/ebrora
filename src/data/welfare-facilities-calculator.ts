...
export const CDM_CHECKLIST: ChecklistItem[] = [
  { id: "wc_provision", category: "Sanitary", requirement: "Suitable and sufficient sanitary conveniences at readily accessible places", regulation: "CDM 2015 Sch.2 Para.1(1)" },
  { id: "wc_separate", category: "Sanitary", requirement: "Separate rooms for men and women (or lockable rooms used by one person at a time)", regulation: "CDM 2015 Sch.2 Para.1(4)" },
  { id: "wc_ventilated", category: "Sanitary", requirement: "Conveniences adequately ventilated and lit", regulation: "CDM 2015 Sch.2 Para.1(2)" },
  { id: "wc_clean", category: "Sanitary", requirement: "Kept in a clean and orderly condition", regulation: "CDM 2015 Sch.2 Para.1(3)" },
  { id: "wash_hot_cold", category: "Hygiene", requirement: "Wash facilities with hot and cold (or warm) running water, soap, and towels/dryers", regulation: "CDM 2015 Sch.2 Para.2(3)" },
  { id: "wash_adjacent", category: "Hygiene", requirement: "Washing facilities in the immediate vicinity of sanitary conveniences", regulation: "CDM 2015 Sch.2 Para.2(1)" },
  { id: "wash_separate", category: "Hygiene", requirement: "Separate facilities for men and women where necessary for privacy", regulation: "CDM 2015 Sch.2 Para.2(6)" },
  { id: "wash_showers", category: "Hygiene", requirement: "Showers provided where required by the nature of the work or health reasons", regulation: "CDM 2015 Sch.2 Para.2(1)" },
  { id: "water_drinking", category: "Hygiene", requirement: "Wholesome drinking water readily accessible and conspicuously marked", regulation: "CDM 2015 Sch.2 Para.3(1)" },
  { id: "water_cups", category: "Hygiene", requirement: "Cups or drinking vessels provided (unless water supplied via drinking fountain)", regulation: "CDM 2015 Sch.2 Para.3(2)" },
  { id: "changing_room", category: "Changing", requirement: "Changing rooms provided where operatives wear special clothing and cannot be expected to change elsewhere", regulation: "CDM 2015 Sch.2 Para.4(1)" },
  { id: "changing_secure", category: "Changing", requirement: "Secure storage for personal clothing not worn at work and for special/protective clothing", regulation: "CDM 2015 Sch.2 Para.4(4)" },
  { id: "changing_drying", category: "Changing", requirement: "Facilities for drying clothing that has become wet", regulation: "CDM 2015 Sch.2 Para.4(3)" },
  { id: "rest_seating", category: "Rest", requirement: "Rest facilities with adequate seating and tables", regulation: "CDM 2015 Sch.2 Para.5(1)" },
  { id: "rest_heated", category: "Rest", requirement: "Rest facilities include arrangements for preparing and eating meals (heating food, boiling water)", regulation: "CDM 2015 Sch.2 Para.5(2)" },
  { id: "rest_shelter", category: "Rest", requirement: "Suitable and sufficient facilities for shelter from adverse weather where work is outdoors", regulation: "CDM 2015 Sch.2 Para.5(3)" },

...
import type { RfiTemplateConfig } from '@/lib/rfi/types';

interface RfiTemplatePreviewModalProps {
  template: RfiTemplateConfig;
  onClose: () => void;
}

export default function RfiTemplatePreviewModal({ template, onClose }: RfiTemplatePreviewModalProps) {

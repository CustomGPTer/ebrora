...
export default function RamsLandingClient() {
  ...
  const handleDescriptionSubmit = useCallback(async (desc: string) => {
        ...
        setStep('generating');
          ...
          if (!res.ok) {
                    const data = await safeJsonParse(res, 'Failed to generate questions. Please sign in or try again.');
  ...
  const handleQuestionsComplete = useCallback(async (answers: AnsweredQuestion[]) => {
        ...
        setStep('generating');
          ...
          if (!res.ok) {
                    const data = await safeJsonParse(res, 'Failed to generate document. Please sign in or try again.');
        ...
        <div className="rams-builder">
          ...
          {error && (
                  <div className="rams-error">
                            ...
                            <button onClick={() => setError(null)} className="rams-error-close">×</button>button>
                  </div>div>
              )}

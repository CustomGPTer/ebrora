...
import { TemplateConfig } from '@/lib/rams/types';
...
export default function TemplatePreviewModal({ template, onClose }: TemplatePreviewModalProps) {
  ...
  // Build the full page list: real preview images + placeholders for remaining pages
  ...
  const scoringLabel: Record<string, string> = {
    'L_x_S': 'Likelihood × Severity',
    'HML': 'High / Medium / Low',
    'L_x_S_x_D': 'L × S × Detectability (RPN)',
    'HML_INTEGRATED': 'Integrated H/M/L per Step',
  };
          ...
          <div className="tpm-details">
            ...
            <div className="tpm-meta">
              ...
              <span className="tpm-meta-pill">
                ...
                {scoringLabel[template.scoringMethod] || template.scoringMethod}
              </span>
            </div>

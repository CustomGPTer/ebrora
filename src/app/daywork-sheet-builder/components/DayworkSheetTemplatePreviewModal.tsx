...
import { DayworkSheetTemplateConfig } from '@/lib/daywork-sheet/types';

interface DayworkSheetTemplatePreviewModalProps {
  template: DayworkSheetTemplateConfig;
  onClose: () => void;
}

const LAYOUT_LABEL: Record<string, string> = {
  standard: 'Standard Layout',
  ceca: 'CECA Civil Engineering Layout',
  jct: 'JCT Prime Cost Layout',
  nec4: 'NEC4 Defined Cost Layout',
  compact: 'Compact Field Layout',
  audit: 'Audit Trail Layout',
  subcontractor: 'Subcontractor Valuation Layout',
  weekly: 'Weekly Summary Layout',
};

export default function DayworkSheetTemplatePreviewModal({ template, onClose }: DayworkSheetTemplatePreviewModalProps) {

...
const toolSchema = {
  ...
  name: 'Ebrora AI Delay Notification Builder',
  ...
  twitter: {
    ...
    title: 'AI Delay Notification Builder | Ebrora',
    description: 'Delay Notification with 3 templates.',
    images: ['/og-image.jpg'],
  },
};
export default function Page() { return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto px-6 pt-4">
        <BreadcrumbNav items={[{ label: "AI Tools", href: "/" }, { label: "Commercial" }, { label: "Delay Notification Builder" }]} />
      </div>
      <DelayBuilderClient />
    </>
  ); }

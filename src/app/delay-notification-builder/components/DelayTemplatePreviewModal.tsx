...
import type { DelayTemplateConfig } from '@/lib/delay/types';

interface DelayTemplatePreviewModalProps {
  template: DelayTemplateConfig;
  onClose: () => void;
}

export default function DelayTemplatePreviewModal({ template, onClose }: DelayTemplatePreviewModalProps) {

...
const DEDICATED_ROUTES = ["materials-converter", "access-equipment-selector", "manual-handling-calculator", "fuel-usage-calculator", "wbgt-heat-stress-calculator", "fire-risk-score-calculator", "plant-pre-use-checksheet", "construction-productivity-calculator", "concrete-volume-calculator", "aggregate-calculator", "excavation-spoil-calculator", "trench-backfill-calculator", "brick-block-calculator", "concrete-pour-planner", "hav-calculator", "confined-space-calculator", "welfare-facilities-calculator", "dust-silica-calculator", "noise-exposure-calculator", "slip-risk-calculator", "cbr-modulus-converter", "topsoil-calculator", "drainage-pipe-flow-calculator", "uv-index-exposure-checker", "cold-stress-wind-chill-calculator", "lone-worker-risk-calculator", "fatigue-risk-calculator", "first-aid-needs-calculator", "scaffold-load-calculator", "formwork-pressure-calculator", "sling-swl-calculator", "soil-compaction-calculator", "sunrise-sunset-times", "plate-bearing-test-interpreter", "cable-trench-depth-checker", "concrete-curing-estimator", "working-days-calculator", "daywork-rate-calculator", "plant-hire-comparator", "overtime-cost-calculator", "ecological-exclusion-zone-checker", "coordinate-converter", "historical-weather", "working-at-height-calculator", "riddor-reporting-decision-tool", "asbestos-notification-decision-tool", "org-chart-generator", "site-induction-duration-calculator", "fire-extinguisher-selector", "temporary-traffic-management-selector", "working-time-regulations-calculator", "ladder-stepladder-justification-tool", "f10-notification-checker", "excavation-batter-angle-calculator"];

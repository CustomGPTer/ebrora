...
const DEDICATED_ROUTES = ["materials-converter", "access-equipment-selector", "manual-handling-calculator", "fuel-usage-calculator", "wbgt-heat-stress-calculator", "fire-risk-score-calculator", "plant-pre-use-checksheet", "construction-productivity-calculator"];

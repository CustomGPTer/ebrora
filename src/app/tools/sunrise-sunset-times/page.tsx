// src/app/tools/sunrise-sunset-times/page.tsx
...
const SunriseSunsetTimesClient = dynamic(
  () => import("@/components/sunrise-sunset-times/SunriseSunsetTimesClient"),
  {
    ssr: false,
    loading: () => (
...
const pageSchema = { "@context": "https://schema.org", "@type": "SoftwareApplication", name: "Sunrise & Sunset Times — 12 UK Cities", description: "Calculate sunrise, sunset, civil twilight, and recommended construction working hours for 12 major UK cities. Day, week, and month views with professional PDF export. Based on the NOAA Solar Position Algorithm.", url: "https://www.ebrora.com/tools/sunrise-sunset-times", applicationCategory: "UtilitiesApplication", operatingSystem: "Web", offers: { "@type": "Offer", price: "0", priceCurrency: "GBP" }, publisher: { "@type": "Organization", name: "Ebrora", url: "https://www.ebrora.com" } };

export default function SunriseSunsetTimesPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(pageSchema) }} />
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <BreadcrumbNav items={[{ label: "Free Tools", href: "/tools" }, { label: "Sunrise & Sunset Times" }]} />

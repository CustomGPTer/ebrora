            ...
            >
              ...
              <div className="bg-gradient-to-r from-[#1B5745] to-[#236b55] px-5 py-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <svg className="w-4.5 h-4.5 text-white/80" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {/* Body */}
              <div className="p-5">
                <h3 className="text-base font-bold text-gray-900 group-hover:text-[#1B5745] transition-colors">
                  {tool.name}
                </h3>
                ...
                {tool.features && (
                  <div className="mt-4 flex flex-wrap gap-1.5">
                    {tool.features.split(",").slice(0, 4).map((feature, i) => (
                      <span
                        key={i}

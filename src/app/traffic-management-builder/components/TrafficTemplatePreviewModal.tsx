...
import type { TrafficTemplateConfig } from '@/lib/traffic/types';

interface TrafficTemplatePreviewModalProps {
  template: TrafficTemplateConfig;
  onClose: () => void;
}

export default function TrafficTemplatePreviewModal({ template, onClose }: TrafficTemplatePreviewModalProps) {

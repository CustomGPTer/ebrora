...
const toolSchema = {
  ...
  twitter: {
    ...
    title: 'AI Traffic Management Plan Builder | Ebrora',
    description: 'Professional traffic management plan documents.',
    images: ['/og-image.jpg'],
  },
};
export default function Page() { return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto px-6 pt-4">
        <BreadcrumbNav items={[{ label: "AI Tools", href: "/" }, { label: "Health & Safety" }, { label: "Traffic Management Plan Builder" }]} />
      </div>

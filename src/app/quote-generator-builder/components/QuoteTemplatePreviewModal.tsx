...
import type { QuoteTemplateConfig } from '@/lib/quote/types';

interface QuoteTemplatePreviewModalProps {
  template: QuoteTemplateConfig;
  onClose: () => void;
}

export default function QuoteTemplatePreviewModal({ template, onClose }: QuoteTemplatePreviewModalProps) {
        ...
        <div className="tpm-layout">
          ...
          <div className="tpm-details">
            ...
            <div className="tpm-meta">
              ...
              <span className="tpm-meta-pill" style={{ backgroundColor: `#${template.accentColor}10`, color: `#${template.accentColor}` }}>
                {template.detailLevel} detail
              </span>
            </div>

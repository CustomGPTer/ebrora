...
import { SafetyAlertTemplateConfig } from '@/lib/safety-alert/types';

interface SafetyAlertTemplatePreviewModalProps {
  template: SafetyAlertTemplateConfig;
  onClose: () => void;
}

const LAYOUT_LABEL: Record<string, string> = {
  standard: 'Standard Layout',
  emergency: 'Red Emergency Layout',
  lessons: 'Lessons Learned Layout',
  investigation: 'Formal Investigation Layout',
};

export default function SafetyAlertTemplatePreviewModal({ template, onClose }: SafetyAlertTemplatePreviewModalProps) {

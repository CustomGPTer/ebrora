...
import { NcrTemplateConfig } from '@/lib/ncr/types';

interface NcrTemplatePreviewModalProps {
  template: NcrTemplateConfig;
  onClose: () => void;
}

const LAYOUT_LABEL: Record<string, string> = {
  standard: 'Standard Layout',
  iso: 'ISO 9001 Formal Layout',
  alert: 'Red Alert Layout',
  compact: 'Compact Close-Out Layout',
  supplier: 'Supplier NCR Layout',
  audit: 'Audit Trail Layout',
};

export default function NcrTemplatePreviewModal({ template, onClose }: NcrTemplatePreviewModalProps) {

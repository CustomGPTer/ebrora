...
import type { RiddorTemplateConfig } from '@/lib/riddor/types';

interface Props { template: RiddorTemplateConfig; onClose: () => void; }

export default function RiddorTemplatePreviewModal({ template, onClose }: Props) {

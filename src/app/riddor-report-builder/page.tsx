...
const toolSchema = {
  ...
  twitter: {
    ...
    title: 'AI RIDDOR Report Builder | Ebrora',
    description: 'RIDDOR 2013 compliant incident reports with root cause analysis and 3 templates.',
    images: ['/og-image.jpg'],
  },
};
export default function Page() { return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto px-6 pt-4">
        <BreadcrumbNav items={[{ label: "AI Tools", href: "/" }, { label: "Health & Safety" }, { label: "RIDDOR Report Builder" }]} />
      </div>
      <RiddorBuilderClient />
    </>
  ); }

...
const FORMAT_MAP: Record<string, { label: string; dbFormat: TemplateFormat; description: string }> = {
  excel: {
    label: "Excel",
    dbFormat: TemplateFormat.EXCEL,
    description: "Free Excel spreadsheet templates for construction project management, health and safety, quality, commercial, and site management.",
  },
  word: {
    label: "Word",
    dbFormat: TemplateFormat.WORD,
    description: "Free Word document templates for construction including temporary works, subcontractor management, document control, and meeting minutes.",
  },
  powerpoint: {
    label: "PowerPoint",
    dbFormat: TemplateFormat.POWERPOINT,
    description: "Free PowerPoint presentation templates for construction reporting, handover packs, and management summaries.",
  },
};
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `Free ${config.label} Templates | Ebrora`,
      description: config.description,

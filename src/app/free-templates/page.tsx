              ...
              <>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                        ...
                        {/* Format cards */}
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                              ...
                              <Link
                                            ...
                                            <h2 className="text-lg font-bold text-gray-900 mt-4">{card.label}</h2>h2>
                        ...
                        {/* How it works */}
                            <div className="mt-14 text-center">
                                      <h2 className="text-lg font-bold text-gray-900">How it works</h2>h2>
                  ...
                  { step: "3", title: "Download", desc: "Get the file and start using it" },
                                                ...
                                                <div key={item.step} className="flex flex-col items-center">
                                                                ...
                                                                <h3 className="text-sm font-semibold text-gray-900 mt-2">{item.title}</h3>h3>
                                                                <p className="text-xs text-gray-500 mt-0.5">{item.desc}</p>p>
                                                </div>div>
                                              ))}
                                      </div>div>
                            </div>div>

...
const FORMAT_CARDS = [
  {
    ...
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M8 8l3.5 4L8 16M13 8l3.5 4L13 16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    colour: "emerald",
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
        <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" strokeWidth="1.5" />
        <path d="M7 8l2.5 8L12 10l2.5 6L17 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    colour: "blue",
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
        <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" strokeWidth="1.5" />
        <path d="M9 7v10M9 7h3.5a3 3 0 010 6H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    colour: "orange",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {FORMAT_CARDS.map((card) => (
            ...
            >
              <div className={`w-16 h-16 rounded-2xl bg-white flex items-center justify-center mx-auto shadow-sm ${card.iconClass}`}>
                {card.icon}
              </div>

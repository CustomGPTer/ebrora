...
import type { WbvTemplateConfig } from '@/lib/wbv/types';

interface Props { template: WbvTemplateConfig; onClose: () => void; }

export default function WbvTemplatePreviewModal({ template, onClose }: Props) {

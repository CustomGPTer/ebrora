        ...
        <div className="auth-page">
              <div className="auth-card">
                      <div className="auth-card__header">
                                <h1 className="page-header">Welcome Back</h1>h1>
                                <p>Sign in to your Ebrora RAMS Builder account</p>p>
                      </div>div>
                ...
                {error && (
                    <div className="alert alert--error">
                      ...
                      <div className="auth-card__divider">or continue with email</div>div>

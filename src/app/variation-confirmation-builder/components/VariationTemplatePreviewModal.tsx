...
import type { VariationTemplateConfig } from '@/lib/variation/types';

interface VariationTemplatePreviewModalProps {
  template: VariationTemplateConfig;
  onClose: () => void;
}

export default function VariationTemplatePreviewModal({ template, onClose }: VariationTemplatePreviewModalProps) {

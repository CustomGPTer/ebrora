...
import type { ScopeTemplateConfig } from '@/lib/scope/types';

interface ScopeTemplatePreviewModalProps {
  template: ScopeTemplateConfig;
  onClose: () => void;
}

export default function ScopeTemplatePreviewModal({ template, onClose }: ScopeTemplatePreviewModalProps) {

...
import type { CeTemplateConfig } from '@/lib/ce/types';

interface CeTemplatePreviewModalProps {
  template: CeTemplateConfig;
  onClose: () => void;
}

export default function CeTemplatePreviewModal({ template, onClose }: CeTemplatePreviewModalProps) {

...
import { CoshhTemplateConfig } from '@/lib/coshh/types';

interface CoshhTemplatePreviewModalProps {
  template: CoshhTemplateConfig;
  onClose: () => void;
}

const LAYOUT_LABEL: Record<string, string> = {
  standard: 'Standard Layout',
  banded: 'Banded Layout',
  technical: 'Technical Layout',
  compact: 'Compact Layout',
  audit: 'Audit-Ready Layout',
};

export default function CoshhTemplatePreviewModal({ template, onClose }: CoshhTemplatePreviewModalProps) {

...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
        ...
        openGraph: {
                ...
                description:
                          category.description ||
                          `Free ${category.name} toolbox talks for construction.`,
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                      ...
                      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                        ...
                        <div className="text-center py-16">
                                        ...
                                        <h2 className="text-lg font-semibold text-gray-900">No talks yet</h2>h2>
                        ...
                        <>
                          ...
                          {freeTalks.length > 0 && (
                                            <div className="mb-10">
                                                                <div className="flex items-center gap-2 mb-4">
                                                                                      <h2 className="text-base font-bold text-gray-900">Free Downloads</h2>h2>
                          ...
                          {gatedTalks.length > 0 && (
                                            <div>
                                                                <div className="flex items-center gap-2 mb-4">
                                                                                      <h2 className="text-base font-bold text-gray-900">Sign Up to Download</h2>h2>

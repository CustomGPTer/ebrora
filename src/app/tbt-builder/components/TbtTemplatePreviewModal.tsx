...
import { TbtTemplateConfig } from '@/lib/tbt/tbt-types';

interface TbtTemplatePreviewModalProps {
  template: TbtTemplateConfig;
  onClose: () => void;
}
...
const LAYOUT_LABEL: Record<string, string> = {
  ...
  banded: 'Colour-Banded Layout',
  card: 'Card-Based Layout',
};

export default function TbtTemplatePreviewModal({ template, onClose }: TbtTemplatePreviewModalProps) {
            ...
            {pages.length > 1 && (
              <div className="tpm-thumbstrip">
                {pages.map((page, i) => (
                  ...
                  >
                    {page.isPlaceholder ? (
                      <div className="tpm-thumb-placeholder">
          ...
          <div className="tpm-details">
            ...
            {pages.length > 1 && (
              <div className="tpm-hint">
                <span className="tpm-hint-key">←</span>
                <span className="tpm-hint-key">→</span>

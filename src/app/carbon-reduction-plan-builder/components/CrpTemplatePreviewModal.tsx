...
import type { CrpTemplateConfig } from '@/lib/carbon-reduction/types';

interface CrpTemplatePreviewModalProps {
  template: CrpTemplateConfig;
  onClose: () => void;
}

export default function CrpTemplatePreviewModal({ template, onClose }: CrpTemplatePreviewModalProps) {

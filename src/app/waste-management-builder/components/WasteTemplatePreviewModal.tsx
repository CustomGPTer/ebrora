...
import type { WasteTemplateConfig } from '@/lib/waste/types';

interface WasteTemplatePreviewModalProps {
  template: WasteTemplateConfig;
  onClose: () => void;
}

export default function WasteTemplatePreviewModal({ template, onClose }: WasteTemplatePreviewModalProps) {
